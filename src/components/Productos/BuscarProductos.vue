  ...
  <div>
    ...
    <div class="header">
      ...
      <input
        type="text"
        v-model="producto"
        placeholder="Ingrese un nombre de producto, precio máximo o categoría"
      />
    </div>
    ...
    <div class="row">
      <div
        ...
        v-for="(item, $index) in productoDisponiblePorNombre(producto.toLowerCase())"
        :key="$index"
      >
...
export default {
  ...
  computed: mapGetters('productos', ['productoDisponiblePorNombre'])
}
</script>
...
input {
  width: 57vw;
  height: 40px;
  background-color: rgb(158, 168, 136);
